...
Two-segment tags such as `v1.7` are the public release shape. Executable builds
normalize them to full semver versions such as `1.7.0` only where packaging or
updater tooling requires it, while public asset names keep `1.7`.
